...
# root@anydeploy:/nfs/images# lsblk -f #!/bin/bash
#!/bin/bash| grep sda2 | awk '{print $2}'
# ext4
...
#dd if=/dev/sda of=/nfs/images/test_#!/bin/bash
#!/bin/bashwin10_kvm/mbr.img bs=512 count=1 status=progress
